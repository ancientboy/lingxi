...
import { listUserSessions, getUserChatHistory, resolveUserSessionPrefix, abortChat, patchSession, deleteSession, callGatewayMethod, } from "./gateway-api.js";
import { handleManagementMethod, MANAGEMENT_METHODS, startHealthMonitor, stopHealthMonitor, } from "./management-handlers.js";
export function createWsBridge(account, gatewayApi) {
    const clients = new Map(); // userId → Set<ClientInfo>
